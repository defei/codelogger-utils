...
public class StringUtilsTest {
    ...
    public void replacIgnoreCase_paramenterIsCorrect_returnCorrectValue() {
        ...
        source = "I am JusT for and Just FOR test!";
        String target = "just for";
        String replacement = "king of";
        String result = StringUtils.replacIgnoreCase(source, target, replacement);
    ...
    public void deleteIgnoreCase_paramenterIsCorrect_returnCorrectValue() {
        ...
        source = "I am just for just for test!";
        String deleteIgnoreCase = StringUtils.deleteIgnoreCase(source, destination);
