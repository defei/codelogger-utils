...
public class DateUtilsTest implements Runnable {
  ...
  public void getDateFormat_byStringDate() throws ParseException {
    ...
    String dateFormat = DateUtils
      .getDateFormat(fullTestDate, fullTestDateFormat, "MMM dd 23:59:59");
  ...
  @Test
  public void formatToEndOfDay() {

    Date expectedDate = buildDate("1000-01-31 23:59:59", fullTestDateFormat);
    Date date = buildDate("1000-01-31 13:21:45", fullTestDateFormat);
    Date endOfDay = DateUtils.formatToEndOfDay(date);
    assertEquals(expectedDate, endOfDay);
  }
