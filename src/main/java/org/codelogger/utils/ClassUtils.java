...
public abstract class ClassUtils {
    ...
    /**
     * 返回给定对象的类型。<br>
     * 如果给定对象为 null 则返回 null.</br>
     * Returns given object class type.<br>
     ...
     * Returns the given object component type.<br>
     ...
     * Returns given object wrapper class or self class.<br>
     ...
     * e.g: <span
     * style="color:blue">org.codelogger.utils.ClassUtils</span><br>
     ...
     * e.g: given class is:<span style="color:blue">java.lang.Object</span>,
     * then return:<span style="color:blue">Object</span>
     * 
     * @param object
     *            any object.
     ...
     *             if given class no default constructor found.
     */
    public static <T> T instantiateClass(final Class<T> clazz) throws IllegalArgumentException,
            BeanInstantiationException {

        return instantiateClass(clazz, MethodUtils.EMPTY_PARAMETER_CLASSTYPES, MethodUtils.EMPTY_PARAMETER_VALUES);
    }
     ...
     *            constructor parameters class type array.
     * @param parameterValues
     *            constructor parameters value array.
     * @return a newly allocated instance of the class represented by this
     *         class.
     * @throws BeanInstantiationException
     *             if given class no given parameter types constructor found.
     */
