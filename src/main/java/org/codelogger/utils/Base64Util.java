...
public class Base64Util {
    ...
    /**
     * Maximum line length (76) of org.codelogger.utils.Base64Util
     * output.
     */
    ...
    /**
     * The 64 valid org.codelogger.utils.Base64Util values.
     */
    ...
    /**
     * Translates a org.codelogger.utils.Base64Util value to either its
     * 6-bit reconstruction value or a negative number indicating some other
     * meaning.
     */
     ...
     * returns a four-byte array in org.codelogger.utils.Base64Util
     * notation. The actual number of significant bytes in your array is given
     * by <var>numSigBytes</var>. The array <var>threeBytes</var> needs only be
     * as big as <var>numSigBytes</var>. Code can reuse a byte array by passing
     * a four-byte array as <var>b4</var>.
     * 
     * @param b4
     ...
     * @return four byte array in org.codelogger.utils.Base64Util
     *         notation.
     * @since 1.5.1
     */
     ...
     * resulting four org.codelogger.utils.Base64Util bytes to
    ...
    /**
     * Serializes an object and returns the
     * org.codelogger.utils.Base64Util -encoded version of that
     ...
     * @return The org.codelogger.utils.Base64Util -encoded object
     * @since 1.4
     */
     ...
     * <p/>
     * Example:
     * <code>encodeObject( myObj, org.codelogger.utils.Base64Util .GZIP )</code>
     * or
     * <p/>
     * Example:
     * <code>encodeObject( myObj, org.codelogger.utils.Base64Util .GZIP | org.codelogger.utils.Base64Util .DONT_BREAK_LINES )</code>
     * 
     * @param serializableObject
     *            The object to encode
     * @param options
    ...
    public static String encodeObject(final java.io.Serializable serializableObject,
        ...
        try {
            ...
            // org.codelogger.utils.Base64Util ->
    ...
    /**
     * Encodes a byte array into org.codelogger.utils.Base64Util
     * notation. Does not GZip-compress data.
     * 
     * @param source
     *            The data to convert
     * @since 1.4
    ...
    /**
     * Encodes a byte array into org.codelogger.utils.Base64Util
     * notation. Does not GZip-compress data. No Line Breaks
     * 
     * @param source
     *            The data to convert
     * @since 1.4
     */
    public static String encodeBytesNoBreaks(final byte[] source) {
     ...
     * <p/>
     * Example:
     * <code>encodeBytes( myData, org.codelogger.utils.Base64Util .GZIP )</code>
     * or
     * <p/>
     * Example:
     * <code>encodeBytes( myData, org.codelogger.utils.Base64Util .GZIP | org.codelogger.utils.Base64Util .DONT_BREAK_LINES )</code>
     * 
     * @param source
     *            The data to convert
     * @param options
    ...
    public static String encodeBytes(final byte[] source, final int off, final int len,
        ...
        if (gzip == GZIP) {
            ...
            try {
                // GZip -> org.codelogger.utils.Base64Util -> ByteArray
                baos = new java.io.ByteArrayOutputStream();
                b64os = new Base64Util.OutputStream(baos, ENCODE | dontBreakLines);
                gzos = new java.util.zip.GZIPOutputStream(b64os);
    ...
    public static byte[] decode(final byte[] source, final int off, final int len) {
        ...
        for (i = off; i < off + len; i++) {
                                              ...
                                              // better
            {
                ...
                System.err.println("Bad org.codelogger.utils.Base64Util input character at "
                        + i + ": " + source[i] + "(decimal)");
                return null;
            } // end else:
     ...
     * deserialize a Java Object within. Returns <tt>null</tt> if there was an
     * error.
     * 
     * @param encodedObject
     *            The org.codelogger.utils.Base64Util data to decode
    ...
    public static boolean encodeToFile(final byte[] dataToEncode, final String filename) {
        ...
        try {
            bos = new Base64Util.OutputStream(new java.io.FileOutputStream(filename),
                    Base64Util.ENCODE);
     ...
     * 
     * @param dataToDecode
     *            org.codelogger.utils.Base64Util -encoded data as a
     *            string
     * @param filename
    ...
    public static byte[] decodeFromFile(final String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64Util.InputStream(new java.io.BufferedInputStream(
    ...
    public static String encodeFromInputStream(final java.io.InputStream ins, long fileLength) {
        ...
        try {
            ...
            bis = new Base64Util.InputStream(
                    new java.io.BufferedInputStream(ins, Base64Util.ENCODE));
    ...
    public static class InputStream extends java.io.FilterInputStream {
         ...
         * <p/>
         * Example:
         * <code>new org.codelogger.utils.Base64Util .InputStream( in, org.codelogger.utils.Base64Util .DECODE )</code>
         * 
         * @param in
         *            the <tt>java.io.InputStream</tt> from which to read data.
         * @param options
        ...
        public int read() throws java.io.IOException {
                ...
                // Else decoding
                    ...
                    if (i == 4) {
                        ...
                        throw new java.io.IOException(
                                "Improperly padded org.codelogger.utils.Base64Util input.");
                    } // end
            ...
            // Else error
                ...
                throw new java.io.IOException(
                        "Error in org.codelogger.utils.Base64Util code reading stream.");
            } // end else
        } // end read
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
         ...
         * <p/>
         * Example:
         * <code>new org.codelogger.utils.Base64Util .OutputStream( out, org.codelogger.utils.Base64Util .ENCODE )</code>
         * 
         * @param out
         *            the <tt>java.io.OutputStream</tt> to which data will be
         *            written.
         ...
         * org.codelogger.utils.Base64Util notation. When encoding, bytes
         * are buffered three at a time before the output stream actually gets a
        ...
        public void write(final int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                // Meaningful org.codelogger.utils.Base64Util character?
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    if (position >= bufferLength) // Enough to output.
                    {
                        ...
                        out.write(b4, 0, len);
                        // out.write(
                        // org.codelogger.utils.Base64Util .decode4to3(
                        // buffer
                        // ) );
                        position = 0;
                    } // end if: enough to output
                    ...
                    throw new java.io.IOException(
                            "Invalid character in org.codelogger.utils.Base64Util data.");
        ...
        public void flushBase64() throws java.io.IOException {
            ...
            if (position > 0) {
                if (encode) {
                    ...
                    throw new java.io.IOException(
                            "org.codelogger.utils.Base64Util input not properly padded.");
                } // end else: decoding
