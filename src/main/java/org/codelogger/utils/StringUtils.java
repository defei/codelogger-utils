...
public class StringUtils {
     ...
     * @param source
     *            string to be tested.
     * @return true if the source string is null or all characters in this
     *         string is space; false otherwise.
     */
     ...
     * @param source
     *            string to be tested.
     * @return true if the source string is not null and at least one character
     *         in this string is not space; false otherwise.
     */
     ...
     * 
     * @param text
     *            source string to be handled.
     * @param wordMinimumLength
     *            word minimum length to partition.
     ...
     * 
     * @param text
     *            string text to be tested.
     * @param word
     *            string word to be tested.
    ...
    public static String trimAllWhitespace(final String source) {
        ...
        if (isEmpty(source) || !containsWhitespace(source)) {
            return source;
        }
     ...
     * 
     * @param source
     *            source string want to be handle.
     * @param target
     *            target string want to be replaces.
     * @param replacement
     *            string of replace to.
     ...
     */
    public static String replacIgnoreCase(final String source, final String target,
            final String replacement) {

        StringBuilder result = getStringBuild();
        String temp = source;
        int indexOfIgnoreCase = 0;
        while (true) {
            indexOfIgnoreCase = indexOfIgnoreCase(temp, target);
            if (indexOfIgnoreCase == INDEX_OF_NOT_FOUND) {
                result.append(temp);
                break;
            }
     ...
     * 
     * @param source
     *            source want to be handle.
     * @param target
     *            target string want to be deleted.
     * @return a new string which source string delete destination chars ignore
     *         case sensitive.
     */
    public static String deleteIgnoreCase(final String source, final String target) {

        return replacIgnoreCase(source, target, "");
    }
     ...
     * 
     * @param stringLength
     *            the length of the random string you want.
     ...
     * 
     * @param stringLength
     *            the length of the random passowrd you want.
     ...
     * 
     * @param source
     *            source string to be handle.
     * @param sourceCharset
     *            source string charset name.
     * @param encodingCharset
     *            want encoding to which charset.
     * @return a new string has been encoded.
     * @throws IllegalArgumentExceptionWORD_PATTERN
